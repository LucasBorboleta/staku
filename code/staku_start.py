...
"""staku_start.py installs and draws SVG pictures for the STAKU boardgame."""
...
_staku_svg_script = os.path.join(_product_home, "staku_svg", "staku_svg.py")
...
print()
print("staku_svg ...")
subprocess.run(args=[_venv_python_executable, _staku_svg_script], shell=False, check=True)
print()
print("staku_svg done")
